    ...
    try {
      ...
      if (storedSession) {
        ...
        if (parsed.role === "student") {
          // Reset dummy seeded progression so status akumulasi is empty by default
          if (parsed.xp === 1500 || parsed.xp === 1250 || parsed.xp === 500) {
            parsed.xp = 0;
          }
          if (Array.isArray(parsed.completed_modules) && parsed.completed_modules.includes("mod-aljabar-1") && parsed.completed_modules.length === 1) {
